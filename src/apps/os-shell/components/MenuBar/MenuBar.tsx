    ...
    >
      ...
      <div class="flex items-center gap-3 h-full">
        ...
        <div class="px-2 h-full flex items-center rounded-sm hover:bg-black/10 dark:hover:bg-white/10" title="WiFi">
            <svg class={`w-4 h-4 ${isWifiLikely() ? 'text-text-primary' : 'text-text-secondary'}`} fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856c3.807-3.807 9.98-3.807 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.53 18.22l-.53.53-.53-.53a.75.75 0 00-1.06 1.06l.53.53-.53.53a.75.75 0 101.06 1.06l.53-.53.53.53a.75.75 0 101.06-1.06l-.53-.53.53-.53a.75.75 0 00-1.06-1.06z" />
            </svg>
        </div>
